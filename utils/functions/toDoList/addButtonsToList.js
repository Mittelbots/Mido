...
module.exports.addButtons = async ({ main_interaction }) => {
    ...
    const add_toDo = new ButtonBuilder({
        ...
        customId:
            config.buttons.add_toDo.customId +
            ' $' +
    ...
    const edit_toDo = new ButtonBuilder({
        ...
        customId:
            config.buttons.edit_toDo.customId +
            ' $' +
            main_interaction.user.id +
            '_' +
            getCurrentProjectId(main_interaction.user.id),
    ...
    const set_todo_ready = new ButtonBuilder({
        ...
        customId:
            config.buttons.set_todo_ready.customId +
            ' $' +
            main_interaction.user.id +
            '_' +
            getCurrentProjectId(main_interaction.user.id),
    ...
    const options = new ButtonBuilder({
        ...
        customId:
            config.buttons.options.customId +
            ' $' +
            main_interaction.user.id +
            '_' +
            getCurrentProjectId(main_interaction.user.id),
...
module.exports.addOptionButtons = async ({ main_interaction }) => {
    ...
    const delete_toDo = new ButtonBuilder({
        ...
        customId:
            config.buttons.delete_toDo.customId +
            ' $' +
            main_interaction.user.id +
            '_' +
            getCurrentProjectId(main_interaction.user.id),
